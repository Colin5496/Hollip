...
public class ListViewSwipeGesture_PhoneBook implements View.OnTouchListener {
    Activity activity;
    ...
    public ListViewSwipeGesture_PhoneBook(ListView listView, TouchCallbacks Callbacks, Activity context) {
    ...
    private void GetResourcesValues() {
        ...
        HalfText = activity.getResources().getString(R.string.basic_del);
        HalfTextFinal = activity.getResources().getString(R.string.basic_del);
...
//                                HalfDrawable	=	activity.getResources().getDrawable(R.drawable.content_discard);
    ...
    private void SetBackGroundforList() {
        ...
        mDownView_parent_txt1.setWidth(150);
        mDownView_parent_txt1.setPadding(0, 5, 0, 0);
        // mDownView_parent_txt1.setHeight(textheight);
        mDownView_parent_txt1.setHeight(72);
